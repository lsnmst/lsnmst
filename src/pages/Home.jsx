        ...
        <div>
          ...
          >
            ...
            <div key="17" className='beatrice'>
              ...
              <div className="description"><p><a href="https://watetezi.github.io/beatrice/" target="_blank" rel="noopener noreferrer">\Morembe, my name is Beatrice\ is the story of a fisherwoman and her community on the Uganda-DRC border, a loudspeaker to amplify her voice given the challenges the women are facing for their livelihoods</a></p></div>
              <div className="viz">
          ...
          <div className='biotext'>🕮<br></br><br></br>✻ ✻ ✻ ✻ ✻ ✻<br></br><br></br>Since we are human beings surrounded by an immeasurable  complexity, we couldn't terraform Mars in a matter of a few human generations, or surgically engineer the climate without a torrent of unintended consequences. Therefore, if you need short and simple solutions, first you must be able to see the complexity. My superpower is to turn the simple into the complex (≠ complicated), because once revealed, it will be easier to find solutions. The urge to grasp mechanics, practices, ontologies, and epistemologies, made me fall in love with research and investigations. Especially by building practices in the fields of political ecology and social justice. But there is no such research without fieldwork, so I am available backpacking anytime.<br /><br />Thanks for being here!<br /><br /><br />hello@alessandromusetta.com<br />PGP KEY <a href="img/HgauJwTzvNjsxVS2P3oJX.asc">🔒</a><br /> FINGERPRINT: D43A CD45 175E 79EA F11F D448 C90C 1302 EDCB 1889<br /><br /><br /></div>
        </div></></>
    );
  }
}
