        ...
        <div>
          ...
          >
            ...
            <div key="13" className='defence'>
              ...
              <div className="description">Open Source Investigation (2022). "The Last Line of Defense. Halting the Ecological Crisis and Ecosystem Collapse of the Congo Basin Edge", investigates the concepts of social, ecological and climate justice by focusing on the Watsa territory, Haut-Uélé province, Democratic Republic of the Congo</div>
              <div className="viz">
            ...
            <div key="10" className='onda'>
              ...
              <Popup
                contentStyle={{ backgroundColor: 'rgba(255, 255, 255, 0)', width: "80%", borderStyle: 'none' }}
                trigger={<div className="title">ÁGUA E MATA</div>}
                modal
                nested
              >
                {close => (
            ...
            <div key="06" className='paz'>
              ...
              <Popup
                contentStyle={{ backgroundColor: 'rgba(255, 255, 255, 0)', width: "80%", borderStyle: 'none' }}
                trigger={<div className="title">PACEÑ@S Y ALTEÑ@S</div>}
                modal
                nested
              >
                {close => (
